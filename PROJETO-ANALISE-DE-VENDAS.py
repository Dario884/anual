...
VC = px.pie(dic2df, names='Produtos', values='Quantidade vendida', color='Produtos', template='plotly_dark', hole=0.3, title=f'{dic2df['Quantidade vendida'].sum()} produtos vendidos',
...
app.layout = html.Div(children=[
    ...
    dcc.Graph(id = 'G6', figure = line1),
    dcc.Graph(id = 'G7', figure = line2),
    dcc.Graph(id= 'G8', figure = grafest1),
    dcc.Graph(id = 'G9', figure = grafest2)
])
